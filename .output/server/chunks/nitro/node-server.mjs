...
const _JxN8FeyUGd = defineNitroPlugin(async () => {
  const config = useRuntimeConfig();
  try {
...
const { Schema: Schema$2, model: model$2 } = require$$0;
const ParserSchema = new Schema$2(
  {
...
const Parser = model$2("Parser", ParserSchema);
var parser_model = { ParserSchema, Parser };

const { Schema: Schema$1, model: model$1 } = require$$0;
const ParsedArticleSchema = new Schema$1(
  {
    parserId: { type: Schema$1.Types.ObjectId, ref: "Parser", required: true },
...
const ParsedArticle = model$1("ParsedArticle", ParsedArticleSchema);
var parsed_article_model = { ParsedArticleSchema, ParsedArticle };

const urlPattern = new RegExp(
  "^(https?:\\/\\/)?((([a-z\\d]([a-z\\d-]*[a-z\\d])*)\\.)+[a-z]{2,}|((\\d{1,3}\\.){3}\\d{1,3}))(\\:\\d+)?(\\/[-a-z\\d%_.~+]*)*(\\?[;&a-z\\d%_.~+=-]*)?(\\#[-a-z\\d_]*)?$",
  "i"
);
const _8EXouur49d = defineNitroPlugin(async () => {
  try {
    setInterval(async () => {
      console.log("Parsing cycle started...");
      parseArticles(await parser_model.Parser.find({ status: true }));
    }, 1e3 * 60 * 30);
  } catch (error) {
    console.error(error);
  }
});
async function parseArticles(resources) {
  if (resources.length === 0)
    return;
  for (const resource of resources) {
    const links = await getLinks(resource);
    await parser_model.Parser.findByIdAndUpdate(resource.id, {
      lastCheck: Date.now()
    });
    for (const link of links) {
      ...
      if (await parsed_article_model.ParsedArticle.exists({ link: data.url }))
        continue;
      await parsed_article_model.ParsedArticle.create({
...
async function getLinks(resource) {
  const links = [];
  ...
  for (const post of posts) {
    ...
    if (!isValidUrl(link))
      link = new URL(resource.link).origin + link;
    links.push(link);
  }
  return links;
}
...
const assets = {
  "/.DS_Store": {
    ...
    "mtime": "2023-02-14T13:17:43.729Z",
    "size": 6148,
  ...
  "/icons/accept.svg": {
    "type": "image/svg+xml",
    "etag": "\"1ef-c0+SeFwZJyfPWQP0OuMwOvPGm6Q\"",
    "mtime": "2023-02-14T13:17:43.729Z",
    "size": 495,
    "path": "../public/icons/accept.svg"
  },
  "/icons/activity.svg": {
    "type": "image/svg+xml",
    "etag": "\"441-aDdNRgIN2C8AO8kDZ16x8iYLP7Y\"",
    "mtime": "2023-02-14T13:17:43.728Z",
    "size": 1089,
    "path": "../public/icons/activity.svg"
  },
  "/icons/add.svg": {
    "type": "image/svg+xml",
    "etag": "\"1b9-qNtNPe4Tax+2yuWwAEVuwuhhWtI\"",
    "mtime": "2023-02-14T13:17:43.728Z",
    "size": 441,
    "path": "../public/icons/add.svg"
  },
  ...
  "/icons/arrow-swap-horizontal.svg": {
    ...
    "mtime": "2023-02-14T13:17:43.727Z",
    "size": 1000,
  ...
  "/icons/data.svg": {
    ...
    "mtime": "2023-02-14T13:17:43.726Z",
    "size": 1769,
    "path": "../public/icons/data.svg"
  },
  "/icons/document-code.svg": {
    "type": "image/svg+xml",
    "etag": "\"566-5Axb29XRaB2/wxreIa3q96DsDjI\"",
    "mtime": "2023-02-14T13:17:43.726Z",
    "size": 1382,
    "path": "../public/icons/document-code.svg"
  },
  ...
  "/icons/document.svg": {
    ...
    "mtime": "2023-02-14T13:17:43.725Z",
    "size": 798,
    "path": "../public/icons/document.svg"
  },
  "/icons/forward.svg": {
    "type": "image/svg+xml",
    "etag": "\"5ff-KPJm6pSNC10uvn8RyarEPEs+JyQ\"",
    "mtime": "2023-02-14T13:17:43.725Z",
    "size": 1535,
    "path": "../public/icons/forward.svg"
  },
  ...
  "/icons/login.svg": {
    ...
    "mtime": "2023-02-14T13:17:43.724Z",
    "size": 1167,
    "path": "../public/icons/login.svg"
  },
  "/icons/play-dark.svg": {
    "type": "image/svg+xml",
    "etag": "\"2db-EaMwBbBH3f/eFUFz+H/jDdtR/dQ\"",
    "mtime": "2023-02-14T13:17:43.724Z",
    "size": 731,
    "path": "../public/icons/play-dark.svg"
  },
  "/icons/play.svg": {
    "type": "image/svg+xml",
    "etag": "\"2db-0YhlyQ9cQ7InnE7HDcYnakUBQXA\"",
    "mtime": "2023-02-14T13:17:43.723Z",
    "size": 731,
  ...
  "/icons/refresh-2.svg": {
    ...
    "mtime": "2023-02-14T13:17:43.722Z",
    "size": 367,
    "path": "../public/icons/refresh-2.svg"
  },
  "/icons/reject.svg": {
    "type": "image/svg+xml",
    "etag": "\"2db-ql3maWLdFUT6Z/iBiUilltcMsZM\"",
    "mtime": "2023-02-14T13:17:43.721Z",
    "size": 731,
    "path": "../public/icons/reject.svg"
  },
  ...
  "/icons/stop-dark.svg": {
    "type": "image/svg+xml",
    "etag": "\"1b5-oqAUT9m2p018C8J4DOZ2SEZsFBQ\"",
    "mtime": "2023-02-14T13:17:43.720Z",
    "size": 437,
    "path": "../public/icons/stop-dark.svg"
  },
  "/icons/stop.svg": {
    "type": "image/svg+xml",
    "etag": "\"1ba-3vHjHbs0oBg/q+OPtBLrDBEICKQ\"",
    "mtime": "2023-02-14T13:17:43.719Z",
    "size": 442,
    "path": "../public/icons/stop.svg"
  },
  "/icons/teacher.svg": {
    "type": "image/svg+xml",
    "etag": "\"637-1GsBfM0+exDOZE9IHOL6MqHSY+g\"",
    "mtime": "2023-02-14T13:17:43.718Z",
    "size": 1591,
  ...
  "/icons/tick-square.svg": {
    ...
    "mtime": "2023-02-14T13:17:43.717Z",
    "size": 768,
    "path": "../public/icons/tick-square.svg"
  },
  "/icons/trash.svg": {
    "type": "image/svg+xml",
    "etag": "\"712-S2V85IvzJUYKDxgBbmZIaQh++18\"",
    "mtime": "2023-02-14T13:17:43.715Z",
    "size": 1810,
  ...
  "/_nuxt/Gilroy-Black.6a3b4aaf.woff": {
    ...
    "mtime": "2023-02-14T13:17:43.713Z",
    "size": 38048,
  ...
  "/_nuxt/Gilroy-Black.dc9aa35f.ttf": {
    ...
    "mtime": "2023-02-14T13:17:43.712Z",
    "size": 82952,
  ...
  "/_nuxt/Gilroy-Black.e2869f4f.woff2": {
    ...
    "mtime": "2023-02-14T13:17:43.711Z",
    "size": 27064,
  ...
  "/_nuxt/Gilroy-BlackItalic.c5677bb4.woff": {
    ...
  "/_nuxt/statistics.cd88bfd8.js": {
    "type": "application/javascript",
    "etag": "\"9d3-5tEPds6lWK5rE+fzZAVqPUezjOk\"",
    "mtime": "2023-02-14T13:17:43.666Z",
    "size": 2515,
    "path": "../public/_nuxt/statistics.cd88bfd8.js"
  },
  "/_nuxt/validation-ai.9d9b78a2.js": {
    "type": "application/javascript",
    "etag": "\"1642-hNlJw56YeJ94kf4QbSah7RbbQ4I\"",
    "mtime": "2023-02-14T13:17:43.666Z",
    "size": 5698,
    "path": "../public/_nuxt/validation-ai.9d9b78a2.js"
  },
  "/_nuxt/validation.474b4367.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"176-TeeQKleAaOyU+4C73b7uKh9IJEw\"",
    "mtime": "2023-02-14T13:17:43.666Z",
    "size": 374,
    "path": "../public/_nuxt/validation.474b4367.css"
  },
  "/_nuxt/validation.78333e58.js": {
    "type": "application/javascript",
    "etag": "\"12b9-OGmdQiFEJVVrbxhtDVGcgmfqCts\"",
    "mtime": "2023-02-14T13:17:43.665Z",
    "size": 4793,
    "path": "../public/_nuxt/validation.78333e58.js"
  }
};
...
const _DXcxCM = defineEventHandler(async (event) => {
  if (globalThis.io)
    return;
...
const _lazy_zqy859 = () => import('../status.put.mjs');
const _lazy_VTu0XR = () => import('../remove.delete.mjs');
const _lazy_ZTUPTz = () => import('../index.get.mjs');
const _lazy_6V6UmF = () => import('../create.post.mjs');
const _lazy_Kryjgo = () => import('../validation.put.mjs');
const _lazy_pm6XrT = () => import('../validation.post.mjs');
const _lazy_w2arpk = () => import('../validation-v2.put.mjs');
const _lazy_kWLTnv = () => import('../validation-v2.post.mjs');
const _lazy_Jgjb1v = () => import('../statistics.post.mjs');
const _lazy_ypMm5E = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _DXcxCM, lazy: false, middleware: true, method: undefined },
  { route: '/api/parsers/status', handler: _lazy_zqy859, lazy: true, middleware: false, method: "put" },
  { route: '/api/parsers/remove', handler: _lazy_VTu0XR, lazy: true, middleware: false, method: "delete" },
  { route: '/api/parsers', handler: _lazy_ZTUPTz, lazy: true, middleware: false, method: "get" },
  { route: '/api/parsers/create', handler: _lazy_6V6UmF, lazy: true, middleware: false, method: "post" },
  { route: '/api/articles/validation', handler: _lazy_Kryjgo, lazy: true, middleware: false, method: "put" },
  { route: '/api/articles/validation', handler: _lazy_pm6XrT, lazy: true, middleware: false, method: "post" },
  { route: '/api/articles/validation-v2', handler: _lazy_w2arpk, lazy: true, middleware: false, method: "put" },
  { route: '/api/articles/validation-v2', handler: _lazy_kWLTnv, lazy: true, middleware: false, method: "post" },
  { route: '/api/articles/statistics', handler: _lazy_Jgjb1v, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_ypMm5E, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ypMm5E, lazy: true, middleware: false, method: undefined }
];
...
export { parsed_article_model as a, article_model as b, getRouteRules as g, nodeServer as n, parser_model as p, require$$0 as r, useNitroApp as u };
