...
const styles = {
  "app.vue": () => import('./_nuxt/app-styles.6f45b8b4.mjs').then(interopDefault),
  "pages/news.vue": () => import('./_nuxt/news-styles.d5cb1b51.mjs').then(interopDefault),
  "pages/login.vue": () => import('./_nuxt/login-styles.6712a3a2.mjs').then(interopDefault),
  "pages/validation.vue": () => import('./_nuxt/validation-styles.040bd6f5.mjs').then(interopDefault),
